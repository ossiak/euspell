...
| **Current versions** | Browser extension 0.3.3; Eupub 0.3.3, both downloadable now. Two channels lag because a reviewer stands in front of them: the Chrome Web Store serves 0.3.2 and the App Store reads 0.2.3, with 0.3.3 submitted to each on 27 August |
...
| **Eupub e-reader** | Windows (signed), macOS (signed + notarized, arm64), Linux, Android (signed APK); iPhone on the **[App Store](https://apps.apple.com/us/app/eupub/id6801994679)** (free, iOS 17+) | **v0.3.3 released** — four signed assets per release. The App Store listing reads 0.2.3 while 0.3.3 sits in review; it is the same reader, and the listing updates itself once Apple clears it |
